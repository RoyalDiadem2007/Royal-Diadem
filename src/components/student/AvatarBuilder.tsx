 ...
 * preview above a row of facet pickers (skin, face shape, eyes, nose, mouth,
 * hair, hair colour, crown). Controlled: it owns no state, just reflects
 * `config` and reports every pick through `onChange`. Purely illustrated
 * in-app — no photo, no upload, nothing sent anywhere to render.
 */
